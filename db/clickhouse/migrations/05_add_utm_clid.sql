-- Create Event
CREATE TABLE entrolytics.website_event_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- stats hourly
CREATE TABLE entrolytics.website_event_stats_hourly_new
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE MATERIALIZED VIEW entrolytics.website_event_stats_hourly_mv_new
TO entrolytics.website_event_stats_hourly_new
AS
SELECT
    website_id,
    session_id,
...
FROM entrolytics.website_event_new
GROUP BY website_id,
    session_id,
    visit_id,
    hostname,
...
-- projections
ALTER TABLE entrolytics.website_event_new
ADD PROJECTION website_event_url_path_projection (
SELECT * ORDER BY toStartOfDay(created_at), website_id, url_path, created_at
);

ALTER TABLE entrolytics.website_event_new MATERIALIZE PROJECTION website_event_url_path_projection;
...
ALTER TABLE entrolytics.website_event_new MATERIALIZE PROJECTION website_event_referrer_domain_projection;

-- migration
INSERT INTO entrolytics.website_event_new
...
FROM entrolytics.website_event

-- rename tables
RENAME TABLE entrolytics.website_event TO entrolytics.website_event_old;
RENAME TABLE entrolytics.website_event_new TO entrolytics.website_event;

RENAME TABLE entrolytics.website_event_stats_hourly TO entrolytics.website_event_stats_hourly_old;
RENAME TABLE entrolytics.website_event_stats_hourly_new TO entrolytics.website_event_stats_hourly;

RENAME TABLE entrolytics.website_event_stats_hourly_mv TO entrolytics.website_event_stats_hourly_mv_old;
RENAME TABLE entrolytics.website_event_stats_hourly_mv_new TO entrolytics.website_event_stats_hourly_mv;

-- recreate view
DROP TABLE entrolytics.website_event_stats_hourly_mv;

CREATE MATERIALIZED VIEW entrolytics.website_event_stats_hourly_mv
TO entrolytics.website_event_stats_hourly
AS
SELECT
    website_id,
    session_id,
