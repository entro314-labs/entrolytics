...
export function UsersTable({
  ...
  return (
    <>
      <DataTable data={safeData} rowKey={(row, index) => row.userId || `row-${index}`}>
        <DataColumn id="displayName" label={formatMessage(labels.name)} width="2fr">
          {(row: any) => (
        ...
        <DataColumn id="websiteCount" label={formatMessage(labels.websites)} align="center">
