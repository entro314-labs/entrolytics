-- Create Event
CREATE TABLE entrolytics.website_event
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
CREATE TABLE entrolytics.event_data
(
    website_id UUID,
    session_id UUID,
    event_id UUID,
...
CREATE TABLE entrolytics.session_data
(
    website_id UUID,
    session_id UUID,
    data_key String,
...
-- stats hourly
CREATE TABLE entrolytics.website_event_stats_hourly
(
    website_id UUID,
    session_id UUID,
    visit_id UUID,
...
-- revenue
CREATE TABLE entrolytics.website_revenue
(
    website_id UUID,
    session_id UUID,
    event_id UUID,
...
CREATE MATERIALIZED VIEW entrolytics.website_revenue_mv
TO entrolytics.website_revenue
AS
SELECT DISTINCT
    ed.website_id,
    ed.session_id,
    ...
    ed.created_at
FROM entrolytics.event_data ed
JOIN (SELECT event_id, string_value as currency
        FROM entrolytics.event_data
