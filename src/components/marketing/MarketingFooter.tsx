  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        <div className={styles.footerBrand}>
          ...
          <div className={styles.socialLinks}>
            <a
              href="https://github.com/entro314-labs/entrolytics"
              target="_blank"
            ...
            <a
              href="https://twitter.com/entrolytics"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="Twitter"
            ...
            <a
              href="https://discord.gg/entrolytics"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="Discord"
        ...
        <div className={styles.linkColumn}>
          ...
          <a
            href="https://status.entrolytics.click"
            target="_blank"
            rel="noopener noreferrer"
            className={`${styles.link} ${styles.linkExternal}`}
          >
          ...
          <a
            href="https://docs.entrolytics.click/api"
            target="_blank"
            rel="noopener noreferrer"
            className={`${styles.link} ${styles.linkExternal}`}
          >
        ...
        <div className={styles.linkColumn}>
          ...
          <Link href="/dpa" className={styles.link}>
            Data Processing
          </Link>
        </div>
      </div>
      ...
      <div className={styles.bottomSection}>
        <p className={styles.copyright}>&copy; {currentYear} Entrolytics. All rights reserved.</p>
