'use client';
import { Button, Grid, Column, Heading } from '@entrolytics/react-zen';
        ...
        <Panel>
          <Grid columns="1fr 1fr 1fr" gap>
            <Column gap>
              ...
              <div>
                <a href="https://www.google.com" data-entrolytics-event="external-link-direct">
              ...
              <div>
                <a
                  ...
                  data-entrolytics-event="external-link-tab"
                  target="_blank"
                  rel="noreferrer"
                >
                  external link (tab)
            ...
            <Column gap>
              ...
              <Button id="send-event-button" data-entrolytics-event="button-click" variant="primary">
                Send event
              </Button>
              <Button
                id="send-event-data-button"
                data-entrolytics-event="button-click"
                data-entrolytics-event-name="bob"
                data-entrolytics-event-id="123"
                variant="primary"
              >
              ...
              <Button
                ...
                data-entrolytics-event="checkout-cart"
                data-entrolytics-event-revenue={(Math.random() * 10000).toFixed(2).toString()}
                data-entrolytics-event-currency="USD"
                variant="primary"
              >
              ...
              <div data-entrolytics-event="div-click">DIV with attribute</div>
              <div data-entrolytics-event="div-click-one">
                <div data-entrolytics-event="div-click-two">
                  <div data-entrolytics-event="div-click-three">Nested DIV</div>
                </div>
              </div>
            </Column>
            <Column gap>
