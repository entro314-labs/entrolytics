...
export const eventData = pgTable(
	"event_data",
	{
		eventDataId: uuid("event_data_id")
			.primaryKey()
	...
	(table) => {
		return {
			...
			websiteEventIdIdx: index("event_data_website_event_id_idx").on(
				table.websiteEventId,
			),
			websiteIdCreatedAtDataKeyIdx: index(
				"event_data_website_id_created_at_data_key_idx",
			).on(table.websiteId, table.createdAt, table.dataKey),
	...
	(table) => {
		return {
			...
			websiteIdSessionIdCreatedAtIdx: index(
				"revenue_website_id_session_id_created_at_idx",
...
export const session = pgTable(
	...
	(table) => {
		return {
			...
			websiteIdCreatedAtBrowserIdx: index(
				"session_website_id_created_at_browser_idx",
			).on(table.websiteId, table.createdAt, table.browser),
			websiteIdCreatedAtCityIdx: index(
				"session_website_id_created_at_city_idx",
			).on(table.websiteId, table.createdAt, table.city),
			websiteIdCreatedAtCountryIdx: index(
				"session_website_id_created_at_country_idx",
			).on(table.websiteId, table.createdAt, table.country),
			websiteIdCreatedAtDeviceIdx: index(
				"session_website_id_created_at_device_idx",
			).on(table.websiteId, table.createdAt, table.device),
			websiteIdCreatedAtIdx: index("session_website_id_created_at_idx").on(
				table.websiteId,
				table.createdAt,
			),
			websiteIdCreatedAtLanguageIdx: index(
				"session_website_id_created_at_language_idx",
			).on(table.websiteId, table.createdAt, table.language),
			websiteIdCreatedAtOsIdx: index("session_website_id_created_at_os_idx").on(
				table.websiteId,
				table.createdAt,
				table.os,
			),
			websiteIdCreatedAtRegionIdx: index(
				"session_website_id_created_at_region_idx",
			).on(table.websiteId, table.createdAt, table.region),
			websiteIdCreatedAtScreenIdx: index(
				"session_website_id_created_at_screen_idx",
			).on(table.websiteId, table.createdAt, table.screen),
...
export const sessionData = pgTable(
	...
	(table) => {
		return {
			...
			websiteIdCreatedAtDataKeyIdx: index(
				"session_data_website_id_created_at_data_key_idx",
			).on(table.websiteId, table.createdAt, table.dataKey),
...
export const websiteEvent = pgTable(
	...
	(table) => {
		return {
			...
			websiteIdCreatedAtHostnameIdx: index(
				"website_event_website_id_created_at_hostname_idx",
			).on(table.websiteId, table.createdAt, table.hostname),
			websiteIdCreatedAtIdx: index(
				"website_event_website_id_created_at_idx",
			).on(table.websiteId, table.createdAt),
			...
			websiteIdCreatedAtTagIdx: index(
				"website_event_website_id_created_at_tag_idx",
			).on(table.websiteId, table.createdAt, table.tag),
			websiteIdCreatedAtUrlPathIdx: index(
				"website_event_website_id_created_at_url_path_idx",
			).on(table.websiteId, table.createdAt, table.urlPath),
			websiteIdCreatedAtUrlQueryIdx: index(
				"website_event_website_id_created_at_url_query_idx",
			).on(table.websiteId, table.createdAt, table.urlQuery),
			websiteIdIdx: index("website_event_website_id_idx").on(table.websiteId),
			websiteIdSessionIdCreatedAtIdx: index(
				"website_event_website_id_session_id_created_at_idx",
			).on(table.websiteId, table.sessionId, table.createdAt),
			websiteIdVisitIdCreatedAtIdx: index(
				"website_event_website_id_visit_id_created_at_idx",
			).on(table.websiteId, table.visitId, table.createdAt),
		};
	},
);
