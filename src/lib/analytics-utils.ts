...
export function getTimestampDiffSQL(
	startField: string,
	endField: string,
): string {
...
export function parseFilters(
	...
	const shouldJoinSession =
		sessionFilters.length > 0 || options?.joinSession;
...
export async function rawQuery(
	...
	console.log("Executing query:", processedQuery, paramValues);
 ...
 */
export function getAddIntervalQuery(
	field: string,
	num: number,
	unit: string,
): string {
