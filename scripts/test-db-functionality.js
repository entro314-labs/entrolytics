...
async function testDatabaseFunctionality() {
  ...
  try {
    ...
    const tableNames = [
      'user', 'org', 'org_user', 'website', 'session', 'website_event',
      'event_data', 'session_data', 'report', 'segment', 'revenue', 'link', 'pixel'
    ]
    ...
    migrations.forEach(migration => {
      const dateStr = migration.created_at ? new Date(Number(migration.created_at)).toISOString() : 'N/A'
