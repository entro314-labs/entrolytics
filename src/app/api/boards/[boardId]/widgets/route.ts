import { z } from 'zod'
import { canViewBoard, canCreateBoardWidget } from '@/validations'
import { parseRequest } from '@/lib/request'
import { json, unauthorized, serverError, badRequest } from '@/lib/response'
import { getBoardWidgets, createBoardWidget, getMaxWidgetPosition } from '@/queries/drizzle'
