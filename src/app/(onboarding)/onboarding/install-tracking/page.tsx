      ...
      <>
        ...
        <div className="onboarding-card">
          <div style={{ textAlign: 'center', padding: '2rem 0' }}>
            ...
            <p style={{ color: 'var(--onboarding-text-secondary)' }}>
      ...
      <div className="onboarding-card" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              border: 'none',
              borderBottom: activeTab === 'cli' ? '2px solid var(--onboarding-primary)' : '2px solid transparent',
              color: activeTab === 'cli' ? 'var(--onboarding-primary)' : 'var(--onboarding-text-secondary)',
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent',
              border: 'none',
              borderBottom: activeTab === 'npm' ? '2px solid var(--onboarding-primary)' : '2px solid transparent',
              color: activeTab === 'npm' ? 'var(--onboarding-primary)' : 'var(--onboarding-text-secondary)',
          ...
          <button
            ...
            style={{
              ...
              background: 'transparent',
              border: 'none',
              borderBottom: activeTab === 'script' ? '2px solid var(--onboarding-primary)' : '2px solid transparent',
              color: activeTab === 'script' ? 'var(--onboarding-primary)' : 'var(--onboarding-text-secondary)',
        ...
        {activeTab === 'cli' && (
          <div style={{ animation: 'fadeInUp 0.4s ease-out' }}>
            <div style={{
              background: 'linear-gradient(135deg, rgba(20, 122, 243, 0.05) 0%, rgba(6, 182, 212, 0.05) 100%)',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                {[
                  { step: '1', title: 'Framework Detection', desc: 'CLI detects your project type automatically' },
                  { step: '2', title: 'Package Installation', desc: 'Installs @entro314labs/entro-nextjs (or your framework)' },
                  { step: '3', title: 'Environment Setup', desc: 'Adds NEXT_PUBLIC_ENTROLYTICS_WEBSITE_ID to .env.local' },
                  { step: '4', title: 'Integration Guide', desc: 'Shows you the exact code to add to your app' },
                ].map((item) => (
        ...
        {/* NPM Tab */}
        {activeTab === 'npm' && (
          <div style={{ animation: 'fadeInUp 0.4s ease-out', fontSize: '15px', color: 'var(--onboarding-text-secondary)', lineHeight: '1.6' }}>
            <p>Manual installation instructions for your framework. This requires more setup but gives you full control.</p>
            <p style={{ marginTop: '1rem', padding: '1rem', background: 'var(--onboarding-bg-elevated)', borderRadius: '8px' }}>
              See our <a href="https://docs.entrolytics.click" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--onboarding-primary)', textDecoration: 'underline' }}>documentation</a> for manual installation steps.
            </p>
          </div>
        )}
        ...
        {activeTab === 'script' && (
          <div style={{ animation: 'fadeInUp 0.4s ease-out' }}>
            <p style={{ fontSize: '15px', color: 'var(--onboarding-text-secondary)', marginBottom: '1rem' }}>
